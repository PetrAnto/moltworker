...
```
2026-03-04 | Codex (GPT-5.2-Codex) (Session: codex-stream-audit-001) | fix(openrouter): clear SSE read timers to prevent DO timeout leaks + surface provider stream errors; add regression tests for timer cleanup/error chunks | src/openrouter/client.ts, src/openrouter/client.test.ts
