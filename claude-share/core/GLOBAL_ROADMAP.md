...
```
2026-03-07 | Codex (GPT-5.2-Codex) (Session: codex-orch-stall-499-001) | fix(task-processor): hard stream cap + 499/client-disconnect retry/rotation to prevent orchestra stall loops | src/durable-objects/task-processor.ts, src/durable-objects/task-processor.test.ts
