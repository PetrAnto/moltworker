...
```
2026-03-31 | Claude Opus 4.6 (Session: session_016Cz67cvLkrjfbSYVKjUUDS) | feat(telegram): P2 done-reaction UX — 👍/👎/⏳ reactions on user messages for direct replies and DO tasks. userMessageId threaded through TaskRequest/TaskState. | src/telegram/handler.ts, src/durable-objects/task-processor.ts
