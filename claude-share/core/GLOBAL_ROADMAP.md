...
```
2026-03-07 | Codex (Session: codex-orch-stall-20260307) | fix(task-processor): prevent false CPU-yield/resume loops by subtracting provider API wall time from iteration active-time accounting; add active-time unit tests | src/durable-objects/task-processor.ts, src/durable-objects/task-processor.test.ts
