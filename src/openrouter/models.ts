...
export const MODELS: Record<string, ModelInfo> = {
  ...
  nemotron: {
    ...
    specialty: 'NVIDIA NIM — Agentic Reasoning/Coding',
    score: '253B dense, 128K ctx, free, strong agentic coding',
    cost: 'FREE',
    isFree: true,
    supportsTools: true,
    provider: 'nvidia',
  ...
  super49: {
    ...
    specialty: 'NVIDIA NIM — Fast Agentic Reasoning',
    score: '49B dense, 128K ctx, free, agentic multi-file',
    cost: 'FREE',
    isFree: true,
    supportsTools: true,
    provider: 'nvidia',
  ...
  nemo3: {
    ...
    score: '120B MoE, 128K ctx, free, agentic coding',
    cost: 'FREE',
    isFree: true,
    supportsTools: true,
    provider: 'nvidia',
  ...
  nemonano: {
    ...
    score: '30B MoE, 1M ctx, free, ultra-fast',
    cost: 'FREE',
    isFree: true,
    provider: 'nvidia',
    maxContext: 1048576,
  ...
  nemo9b: {
    ...
    score: '9B params, 128K ctx, free, fastest',
    cost: 'FREE',
    isFree: true,
    provider: 'nvidia',
    maxContext: 131072,
  ...
  dsnv: {
    ...
    specialty: 'NVIDIA NIM — DeepSeek V3.2 Agentic Coding',
    score: 'DeepSeek V3.2 via NIM, 128K ctx, free, agentic multi-file',
    cost: 'FREE',
    isFree: true,
    supportsTools: true,
    provider: 'nvidia',
  ...
  qwencodernv: {
    ...
    specialty: 'NVIDIA NIM — Qwen3 Coder Agentic 480B MoE (35B active)',
    score: '480B MoE, 256K ctx, free, agentic coding, SWE-Bench strong',
    cost: 'FREE',
    isFree: true,
    supportsTools: true,
    provider: 'nvidia',
  ...
  qwen35nv: {
    ...
    score: '397B MoE, 256K ctx, free, agentic',
    cost: 'FREE',
    isFree: true,
    supportsTools: true,
    provider: 'nvidia',
  ...
  kiminv: {
    ...
    specialty: 'NVIDIA NIM — Kimi K2 Agentic Coding',
    score: 'Kimi K2 via NIM, 256K ctx, free, agentic multi-file',
    cost: 'FREE',
    isFree: true,
    supportsTools: true,
    provider: 'nvidia',
  ...
  devnv: {
    ...
    specialty: 'NVIDIA NIM — Mistral Devstral 2 Agentic Coding',
    score: '123B params, 128K ctx, free, agentic coding',
    cost: 'FREE',
    isFree: true,
    supportsTools: true,
    provider: 'nvidia',
