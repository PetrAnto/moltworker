...
export const MODELS: Record<string, ModelInfo> = {
  ...
  nemotron: {
    ...
    score: '253B params, 128K ctx, free',
    cost: 'Free',
    isFree: true,
    supportsTools: true,
    provider: 'nvidia',
  ...
  super49: {
    ...
    score: '49B params, 128K ctx, free',
    cost: 'Free',
    isFree: true,
    supportsTools: true,
    provider: 'nvidia',
  ...
  nemonano: {
    ...
    specialty: 'NVIDIA NIM — Lightweight MoE 30B (3B active)',
  ...
  dsnv: {
    ...
    score: 'DeepSeek V3.2 via NIM, 128K ctx, free',
    cost: 'Free',
    isFree: true,
    supportsTools: true,
    provider: 'nvidia',
  ...
  qwencodernv: {
    ...
    score: '480B MoE, 256K ctx, free, agentic coding',
    cost: 'Free',
    isFree: true,
    supportsTools: true,
    provider: 'nvidia',
  ...
  kiminv: {
    ...
    score: 'Kimi K2 via NIM, 256K ctx, free',
    cost: 'Free',
    isFree: true,
    supportsTools: true,
    provider: 'nvidia',
  ...
  devnv: {
    ...
    score: '123B params, 128K ctx, free, code-focused',
    cost: 'Free',
    isFree: true,
    supportsTools: true,
    provider: 'nvidia',
