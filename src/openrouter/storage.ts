...
/**
 * Conversational planning state for /orch plan.
 * Accumulates user requirements across multiple messages.
 */
export interface OrchestraPlanState {
  repo: string;
  chatId: number;
  /** Accumulated requirement messages */
  requirements: string[];
}
